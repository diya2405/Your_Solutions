...
<head>
    ...
    <title>Semester 2 | YOURSOLUTION</title>
    <style>
            body {
            margin: 0;
...
<body>
    ...
    <div class="subject-selection-sem1">
        <a href="./subject-resources/sem2/emath.php"><img src="./Photos/sem2/1.png" alt="Subject 1"></a>
        <a href="./subject-resources/sem2/ens.php"><img src="./Photos/sem2/2.png" alt="Subject 2"></a>
        <a href="./subject-resources/sem2/a-python.php"><img src="./Photos/sem2/3.png" alt="Subject 3"></a>
        <a href="./subject-resources/sem2/physics.php"><img src="./Photos/sem2/4.png" alt="Subject 3"></a>
    </div>
